...
def getTextFromTheme(theme, wordsToInclude, targetLength):
    userPrompt = f'Generate a {targetLength} word passage containg all the difficult words {wordsToInclude}. You MUST include every word in {wordsToInclude}.  If you are missing one of these words, our program will be in serious risk of begin shut down and we will not be able to pay our rent. The passage should follow the theme {theme}.'
